...
import org.bdlions.inventory.exceptions.InvalidRequestException;
import org.bdlions.transport.packet.IPacket;
import org.bdlions.transport.packet.IPacketHeader;
import org.bdlions.inventory.request.handler.AuthHandler;
import org.bdlions.inventory.request.handler.RequestExecutorInfo;
...
import org.bdlions.inventory.request.handler.AdjustStockHandler;
...
import org.bdlions.inventory.request.handler.SupplierHandler;
import org.bdlions.inventory.request.handler.UserHandler;
...
public class ClientRequestHandler implements IClientRequestHandler{
    ...
    private Class[] getDelegators() {
        Class[] delegators = new Class[]{AuthHandler.class, UserHandler.class, ProductCategoryHandler.class, ProductHandler.class, CustomerHandler.class, SupplierHandler.class, PurchaseHandler.class, SaleHandler.class, StockHandler.class, SaleReportHandler.class, PurchaseReportHandler.class, AdjustStockHandler.class};
        return delegators;
    }
