    ...
    public ClientResponse addPurchaseOrderInfo(ISession session, IPacket packet) throws Exception 
    {
        ...
        if(products != null && !products.isEmpty())
        {
            ...
            for(int counter = 0; counter < totalProducts; counter++)
            {
                ...
                if(dtoProduct != null && dtoProduct.getEntityProduct() != null && dtoProduct.getEntityProduct().getId() > 0)
                {
                    ...
                    entityPOShowRoomProduct.setQuantity(dtoProduct.getQuantity());
                    //double subtotal = (dtoProduct.getEntityProduct().getCostPrice() * dtoProduct.getQuantity() - (dtoProduct.getEntityProduct().getCostPrice() * dtoProduct.getQuantity() * dtoProduct.getDiscount() / 100));
                    entityPOShowRoomProduct.setSubtotal(dtoProduct.getTotal());
                    entityPOShowRoomProduct.setCreatedOn(TimeUtils.getCurrentTime());
                    entityPOShowRoomProduct.setModifiedOn(TimeUtils.getCurrentTime());
        ...
        if(returnProducts != null && !returnProducts.isEmpty())
        {
            ...
            for(int counter = 0; counter < totalReturnedProducts; counter++)
            {
                ...
                entityPOShowRoomReturnProduct.setQuantity(dtoProduct.getQuantity());
                //double subtotal = (dtoProduct.getEntityProduct().getCostPrice() * dtoProduct.getQuantity() - (dtoProduct.getEntityProduct().getCostPrice() * dtoProduct.getQuantity() * dtoProduct.getDiscount() / 100));
                entityPOShowRoomReturnProduct.setSubtotal(dtoProduct.getTotal());
        ...
        {            
            ...
            if(products != null && !products.isEmpty())
            {
                ...
                for(int counter = 0; counter < totalProducts; counter++)
                {
                    ...
                    if(dtoProduct != null && dtoProduct.getEntityProduct() != null && dtoProduct.getEntityProduct().getId() > 0)
                    {
                        ...
                        EntityPOShowRoomProduct entityPOShowRoomProduct = new EntityPOShowRoomProduct();
                        entityPOShowRoomProduct.setId(dtoProduct.getId());
                        ...
                        {
                            entityPOShowRoomProduct.setCreatedOn(dtoProduct.getEntityProduct().getCreatedOn());
                        }
                        entityPOShowRoomProduct.setModifiedOn(TimeUtils.getCurrentTime());
                        entityPOShowRoomProducts.add(entityPOShowRoomProduct);
            ...
            if(returnProducts != null && !returnProducts.isEmpty())
            {
                ...
                for(int counter = 0; counter < totalReturnedProducts; counter++)
                {
                    ...
                    EntityPOShowRoomReturnProduct entityPOShowRoomReturnProduct = new EntityPOShowRoomReturnProduct();
                    entityPOShowRoomReturnProduct.setId(dtoProduct.getId());
                ...
                for(int counter = 0; counter < entityPOShowRoomProducts.size(); counter++)
                {
                    ...
                    if(stockProduct != null)
                    {
                        ...
                        if(entityProduct != null)
                        {
                            ...
                            dtoProduct.setId(entityPOShowRoomProduct.getId());
                            ...
                            dtoProduct.getEntityProduct().setCreatedOn(entityPOShowRoomProduct.getCreatedOn());
